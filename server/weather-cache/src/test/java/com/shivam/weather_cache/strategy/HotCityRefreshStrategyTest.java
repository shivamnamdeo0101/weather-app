...
class HotCityRefreshStrategyTest {
    ...
    void setup() throws Exception {
        ...
        hotStrategy = new HotCityRefreshStrategy(redisService, weatherSvcClient);

        // Set private fields using reflection
        java.lang.reflect.Field thresholdField = HotCityRefreshStrategy.class.getDeclaredField("hotHitThreshold");
        thresholdField.setAccessible(true);
        thresholdField.set(hotStrategy, 10L);

        java.lang.reflect.Field intervalField = HotCityRefreshStrategy.class.getDeclaredField("hotRefreshInterval");
        intervalField.setAccessible(true);
        intervalField.set(hotStrategy, 1000L);
    }
    ...
    void testRefreshIfRequired_belowThreshold_returnsFalse() {
        ...
        boolean result = hotStrategy.refreshIfRequired("weather:testCity");
    ...
    void testRefreshIfRequired_refreshHappens_callsWeatherSvcAndRedis() {
        ...
        // Since hits < hotHitThreshold in meta, hits should not be reset to 1
